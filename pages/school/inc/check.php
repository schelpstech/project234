...
<body class="g-sidenav-show   bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand d-flex align-items-center m-0" href=" https://crsm.ng " target="_blank">
        ...
        <div class="collapse navbar-collapse px-3  w-auto h-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="#" class="nav-link text-white active opacity-10" aria-controls="dashboardsExamples"
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#pagesExamples1" class="nav-link text-white opacity-9"
                        aria-controls="pagesExamples1" role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center d-flex align-items-center justify-content-center">
                        ...
                        <ul class="nav border-start ms-4">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 "
                                    href="../../app/router.php?pageid=Y29ycG9yYXRlX2Zvcm0=">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 "
                                    href="../../app/router.php?pageid=Y29udGFjdF9mb3Jt">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 "
                                    href="../../app/router.php?pageid=YXBwcm92YWxfcmVjb3Jk">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 "
                                    href="../../app/router.php?pageid=ZmFjaWxpdHlfcmVjb3Jk">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#pagesExamples2" class="nav-link text-white opacity-9"
                        aria-controls="pagesExamples2" role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center d-flex align-items-center justify-content-center">
                    ...
                    <div class="collapse " id="pagesExamples2">
                        <ul class="nav border-start ms-4">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 "
                                    href="../../app/router.php?pageid=YWRkX3BlcnNvbm5lbA==">
                                    <span class="sidenav-mini-icon"> Cpt </span>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 "
                                    href="../../app/router.php?pageid=cG9zdF92YWNhbmN5">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#pagesExamples3" class="nav-link text-white opacity-9"
                        aria-controls="pagesExamples3" role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center d-flex align-items-center justify-content-center">
                    ...
                    <div class="collapse " id="pagesExamples3">
                        <ul class="nav border-start ms-4">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 " href="../../pages/pages/messages.html">
                                    <span class="sidenav-mini-icon"> Bil </span>
                                    <span class="sidenav-normal"> Billings </span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 " href="../../pages/pages/widgets.html">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#pagesExamples4" class="nav-link text-white opacity-9"
                        aria-controls="pagesExamples4" role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center d-flex align-items-center justify-content-center">
                    ...
                    <div class="collapse " id="pagesExamples4">
                        <ul class="nav border-start ms-4">
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 "
                                    href="../../app/router.php?pageid=YWN0aXZpdHlfbG9n">
                                    <span class="sidenav-mini-icon"> L </span>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#pagesExamples5" class="nav-link text-white opacity-9"
                        aria-controls="pagesExamples5" role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#authExamples6" class="nav-link text-white opacity-9"
                        aria-controls="authExamples6" role="button" aria-expanded="false">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center d-flex align-items-center justify-content-center">
                            <svg width="16px" height="16px" viewBox="0 0 40 40" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <div class="collapse " id="authExamples6">
                        <ul class="nav border-start ms-4">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link text-white opacity-9 " href="../../pages/pages/pricing-page.html">
            ...
            <div class="card border-0 border-radius-md" id="sidenavCard">
                <div class="card-body  text-start  p-3 w-100">
                    ...
                    <div class="docs-info">
                        ...
                        <a href="https://www.creative-tim.com/learning-lab/bootstrap/overview/corporate-ui-dashboard"
            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                ...
                <ul class="navbar-nav  justify-content-end">
                    ...
                    <li class="nav-item dropdown pe-2 d-flex align-items-center">
                        <a href="javascript:;" class="p-0 nav-link " id="dropdownMenuButton0" data-bs-toggle="dropdown"
                            aria-expanded="false">
                                ...
                                <a class="dropdown-item border-radius-md" href="javascript:;">
                                    <div class="py-1 d-flex">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <button type="button" class="mb-3 btn btn-block bg-gradient-warning"
                                                data-bs-toggle="modal" data-bs-target="#modal-notification">Log
                                                Out</button>
                        ...
                        <ul class="px-2 py-3 dropdown-menu dropdown-menu-end me-sm-n4"
                            ...
                            <li class="mb-2">
                                <a class="dropdown-item border-radius-md" href="javascript:;">
                                    <div class="py-1 d-flex">
                                        <div class="my-auto">
                                            <img src="../../assets/img/small-logos/alert.svg"
                                                class="avatar avatar-sm bg-gradient-dark  me-3 " alt="logo spotify">
                                        </div>
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-1 text-sm font-weight-normal">
                                                <span class="font-weight-bold">Login Attempt</span> by NG-BE-05-01
                                            </h6>
                            ...
                            <li class="mb-2">
                                <a class="dropdown-item border-radius-md" href="javascript:;">
                                    <div class="py-1 d-flex">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-1 text-sm font-weight-normal">
                                                <span class="font-weight-bold">Logout</span> by NG-BE-05-01
                                            </h6>
                                            <p class="mb-0 text-xs text-secondary">
                                                <i class="fa fa-clock me-1"></i>
                                                2023-05-24 15:50:55
                ...
                <div class="col-md-12">
                    <div class="mx-2 mb-3 d-md-flex align-items-center">
                        <div class="mb-3 mb-md-0">
                            <h5 class="mb-0 font-weight-bold">School code: NG-BE-05-01</h5>
                    ...
                    <div class="pb-0 card-header border-bottom">
                        ...
                        <div class="mb-3 d-sm-flex align-items-center">
                            <div>
                                ...
                                <p class="mb-2 text-sm mb-sm-0">Information provided in this form will be vetted and
                                    will not be editable upon
                                    approval by the secretariat</p>
                            </div>
                            <div class="ms-auto d-flex">
                                <button type="button" onclick="window.print()" class="mb-0 btn btn-sm btn-dark me-2">
                                    <strong>Print</strong>
                                </button>
                        ...
                        <form role="form" class="text-start" autocomplete="off" action="../../app/update.php"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="NG-BE-05-01" disabled />
                                    </div>
                                </div>
                                <div class="col-md-4" style="display: none;" hidden="yes">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">School code:</label>
                                        <input type="text" class="form-control" value="NG-BE-05-01" name="sch_code" />
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="sch_name"
                                            value="Shekinah Light Redeemer's School, Gboko, Benue State" disabled />
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Select School
                                            Facility</label>
                                        <select type="text" class="form-control" name="facility_name" required="yes">
                                            <option value="">select</option>
                                            <option value="13">Alternate Power Generator</option>
                                            <option value="2">Classrooms</option>
                                            <option value="7">Hostel Facility</option>
                                            <option value="17">Internet Facility</option>
                                            <option value="3">Laboratory</option>
                                            <option value="4">Library</option>
                                            <option value="6">Perimeter Fence</option>
                                            <option value="12">Pipe Borne Water</option>
                                            <option value="11">Playground</option>
                                            <option value="16">School Bus</option>
                                            <option value="15">School Hall</option>
                                            <option value="1">School Physical Building</option>
                                            <option value="5">Sick bay</option>
                                            <option value="10">Staff room</option>
                                            <option value="9">Toilets</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Facility
                                            Ownership</label>
                                ...
                                <div class="col-md-8">
                                    <label for="example-text-input" class="form-control-label">Facility
                                        Description</i>:</label>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="description" minlength="50"
                                            maxlength="150" required="yes" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                            ...
                            <hr>
                            <button type="submit" name="submit_facility_record"
                                class="btn btn-dark active btn-lg w-100">Add Facility
                                Details</button>
                            ...
                            <div class="table-responsive">
                                <table class="table table-flush" id="datatable-search">
                                    <thead class="thead-light">
                                        <tr>
                                            <th class="text-secondary text-xs font-weight-semibold opacity-7">Facility
                                            </th>
                                            <th
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="text-sm font-weight-normal">
                                                ...
                                                <div class="align-items-center">
                                                    <img src="../../assets/storage/facility/DGixNu9wakinyemi odunayo.jpg"
                                                        alt="facility" height="100" width="100">
                                                    <br>
                                                    <br>
                                            ...
                                            <td class="text-sm font-weight-normal"
                                                style="width:10%; word-wrap: normal;">
                                                ...
                                                <spmall>
                                                    Information provided in this form will be vetted and will not be
                                                    editable upon approval by the secretariat </small>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="badge badge-sm border border-dark text-dark bg-dark">
                                                    Pending
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="text-sm font-weight-normal">
                                                ...
                                                <div class="align-items-center">
                                                    <img src="../../assets/storage/facility/unADYERbappraisal.jpg"
                                                        alt="facility" height="100" width="100">
                                                    <br>
                                                    <br>
                                                    <h6 class="mtext-sm text-dark font-weight-semibold mb-0">
                                            ...
                                            <td class="text-sm font-weight-normal"
                                                ...
                                                <spmall>
                                                    A 30 students capacity room art studio with creative art gadgets
                                                    like stencils </small>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <span class="badge badge-sm border border-dark text-dark bg-dark">
            ...
            <div class="row align-items-center justify-content-lg-between">
                ...
                <div class="col-lg-6">
                    <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                        <li class="nav-item">
                            <a href="https://www.crsm.ng" class="nav-link text-xs text-muted" target="_blank">CRSM
                                Website</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="../../app/authenticator.php" method="post">
                                <button type="submit" name="log_out_user" value="bG9nX291dF91c2VyX2Zvcm0="
