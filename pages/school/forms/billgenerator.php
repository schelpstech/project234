                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="confirmInvoice"  onchange="toggleButton()">
                            <label class="custom-control-label" for="customCheck1">I affirm that the enrolment and tuition information for all classes are correct and complete. </label>
                        </div>
                    </div>
                </div>
                <hr>
                <button type="submit" name="generateInvoice" id="submitInvoice" disabled class="btn btn-dark active btn-lg w-100">Generate
                    Termly Remittance
                    Invoice</button>
            </form>
        </div>
