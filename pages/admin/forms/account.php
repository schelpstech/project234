                ...
                <div class="pt-0 card-body">
                    ...
                    <div class="pt-3 ps-5 ms-3">
                        ...
                        <div class="p-2 my-4 bg-gray-100 d-sm-flex border-radius-lg">
                            ...
                            <input class="w-40 mt-2 form-control form-control-sm ms-sm-auto mt-sm-0 w-sm-15" type="text"
                        ...
                        <div class="p-2 my-4 bg-gray-100 d-sm-flex border-radius-lg">
                            ...
                            <h6 class="my-auto text-sm ms-auto me-3"><a href="/cdn-cgi/l/email-protection"
                                    class="__cf_email__"
                                    data-cfemail="563e333a3a391635243337223f20337b223f3b7835393b">[email&#160;protected]</a>
                            </h6>
        ...
        <div class="col-lg-9 col-12">
            <div class="card" id="delete">
                <div class="card-header">
                    ...
                    <p class="mb-0 text-sm">Once you delete your account, there is no going back. Please be certain.</p>
                </div>
                <div class="pt-0 card-body d-sm-flex">
                    ...
                    <button class="mb-0 btn btn-white ms-auto" type="button" name="button">Deactivate</button>
                    <button class="mb-0 btn bg-gradient-danger ms-2" type="button" name="button">Delete Account</button>
                </div>
            </div>
        </div>
    </div>